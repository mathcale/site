              ...
              <ul className={styles.socials}>
                <li>
                  <a href="https://github.com/mathcale" title="Github" target="_blank">
                    <Image src="/img/github.svg" width={32} height={32} alt="Github icon" />
                  </a>
                </li>

                <li>
                  <a href="https://linkedin.com/in/mathcale" title="LinkedIn" target="_blank">
                    <Image src="/img/linkedin.svg" width={32} height={32} alt="LinkedIn icon" />
                  </a>
                </li>

                <li>
                  <a href="https://codepen.io/mathcale" title="Codepen" target="_blank">
                    <Image src="/img/codepen.svg" width={32} height={32} alt="Codepen icon" />
                  </a>
                </li>

                <li>
                  <Link href="mailto:hello@matheus.me" title="Contact">
                    <Image src="/img/email.svg" width={32} height={32} alt="E-mail icon" />
                  </Link>
                </li>
              </ul>
            </div>
